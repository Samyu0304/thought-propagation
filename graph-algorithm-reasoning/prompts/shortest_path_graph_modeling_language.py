...
graph[
    ...
    node [id 3]
    node [id 4]
    edge [label "Edge between node 0 and node 3 with distance 2"]
    edge [label "Edge between node 1 and node 4 with distance 3"]
    edge [label "Edge between node 2 and node 4 with distance 5"]
    edge [label "Edge between node 3 and node 4 with distance 3"]
]
Source Node: 0
Target Node: 4
...
graph[
    ...
    node [id 4]
    node [id 5]
    edge [label "Edge between node 0 and node 1 with distance 5"]
    edge [label "Edge between node 1 and node 4 with distance 3"]
    edge [label "Edge between node 2 and node 3 with distance 3"]
    edge [label "Edge between node 3 and node 4 with distance 4"]
    edge [label "Edge between node 3 and node 5 with distance 5"]
    edge [label "Edge between node 4 and node 5 with distance 1"]
]
Source Node: 0
Target Node: 5
...
graph[
    ...
    node [id 5]
    edge [label "Edge between node 0 and node 3 with distance 2"]
    edge [label "Edge between node 0 and node 2 with distance 2"]
    edge [label "Edge between node 1 and node 3 with distance 5"]
    edge [label "Edge between node 1 and node 5 with distance 4"]
    edge [label "Edge between node 2 and node 3 with distance 2"]
    edge [label "Edge between node 2 and node 5 with distance 3"]
    edge [label "Edge between node 3 and node 4 with distance 3"]
    edge [label "Edge between node 4 and node 5 with distance 4"]
]
...
graph[
    ...
    node [id 3]
    node [id 4]
    edge [label "Edge between node 0 and node 2 with distance 5"]
    edge [label "Edge between node 1 and node 4 with distance 3"]
    edge [label "Edge between node 1 and node 2 with distance 2"]
    edge [label "Edge between node 2 and node 4 with distance 1"]
    edge [label "Edge between node 3 and node 4 with distance 1"]
]
...
graph[
    ...
    node [id 8]
    edge [label "Edge between node 0 and node 1 with distance 5"]
    edge [label "Edge between node 0 and node 4 with distance 5"]
    edge [label "Edge between node 1 and node 4 with distance 2"]
    edge [label "Edge between node 1 and node 2 with distance 5"]
    edge [label "Edge between node 2 and node 7 with distance 5"]
    edge [label "Edge between node 3 and node 7 with distance 2"]
    edge [label "Edge between node 3 and node 5 with distance 3"]
    edge [label "Edge between node 4 and node 6 with distance 2"]
    edge [label "Edge between node 5 and node 8 with distance 3"]
    edge [label "Edge between node 6 and node 8 with distance 2"]
    edge [label "Edge between node 7 and node 8 with distance 3"]
]
...
graph[
    ...
    node [id 1]
    ...
    edge [label "Edge between node a index and node b index with distance LENGTH"]
    ...
]
...
graph[
    ...
    node [id 3]
    node [id 4]
    edge [label "Edge between node 0 and node 3"]
    edge [label "Edge between node 1 and node 4"]
    edge [label "Edge between node 2 and node 4"]
    edge [label "Edge between node 3 and node 4"]
]
...
graph[
    ...
    node [id 7]
    node [id 8]
    edge [label "Edge between node 0 and node 1"]
    edge [label "Edge between node 0 and node 4"]
    edge [label "Edge between node 1 and node 4"]
    edge [label "Edge between node 1 and node 2"]
    edge [label "Edge between node 2 and node 7"]
    edge [label "Edge between node 3 and node 7"]
    edge [label "Edge between node 3 and node 5"]
    edge [label "Edge between node 4 and node 6"]
    edge [label "Edge between node 5 and node 8"]
    edge [label "Edge between node 6 and node 8"]
    edge [label "Edge between node 7 and node 8"]
]
...
graph[
    ...
    node [id 17]
    node [id 18]
    edge [label "Edge between node 0 and node 5"]
    edge [label "Edge between node 1 and node 6"]
    edge [label "Edge between node 1 and node 11"]
    edge [label "Edge between node 1 and node 14"]
    edge [label "Edge between node 2 and node 6"]
    edge [label "Edge between node 2 and node 10"]
    edge [label "Edge between node 2 and node 11"]
    edge [label "Edge between node 3 and node 15"]
    edge [label "Edge between node 3 and node 11"]
    edge [label "Edge between node 4 and node 18"]
    edge [label "Edge between node 4 and node 8"]
    edge [label "Edge between node 4 and node 10"]
    edge [label "Edge between node 4 and node 11"]
    edge [label "Edge between node 4 and node 15"]
    edge [label "Edge between node 5 and node 15"]
    edge [label "Edge between node 5 and node 8"]
    edge [label "Edge between node 5 and node 13"]
    edge [label "Edge between node 6 and node 15"]
    edge [label "Edge between node 6 and node 14"]
    edge [label "Edge between node 7 and node 12"]
    edge [label "Edge between node 7 and node 8"]
    edge [label "Edge between node 7 and node 15"]
    edge [label "Edge between node 8 and node 10"]
    edge [label "Edge between node 8 and node 16"]
    edge [label "Edge between node 9 and node 17"]
    edge [label "Edge between node 9 and node 16"]
    edge [label "Edge between node 10 and node 16"]
    edge [label "Edge between node 11 and node 18"]
    edge [label "Edge between node 11 and node 16"]
    edge [label "Edge between node 12 and node 14"]
    edge [label "Edge between node 13 and node 14"]
    edge [label "Edge between node 14 and node 17"]
    edge [label "Edge between node 15 and node 16"]
    edge [label "Edge between node 16 and node 18"]
    edge [label "Edge between node 17 and node 18"]
]
...
graph[
    ...
    node [id 10]
    node [id 11]
    edge [label "Edge between node 0 and node 2"]
    edge [label "Edge between node 1 and node 5"]
    edge [label "Edge between node 2 and node 9"]
    edge [label "Edge between node 3 and node 7"]
    edge [label "Edge between node 3 and node 11"]
    edge [label "Edge between node 4 and node 5"]
    edge [label "Edge between node 4 and node 6"]
    edge [label "Edge between node 5 and node 7"]
    edge [label "Edge between node 6 and node 8"]
    edge [label "Edge between node 7 and node 11"]
    edge [label "Edge between node 8 and node 10"]
    edge [label "Edge between node 9 and node 10"]
    edge [label "Edge between node 10 and node 11"]
]
...
graph[
    ...
    node [id 12]
    edge [label "Edge between node 0 and node 1"]
    edge [label "Edge between node 1 and node 9"]
    edge [label "Edge between node 1 and node 6"]
    edge [label "Edge between node 2 and node 3"]
    edge [label "Edge between node 2 and node 7"]
    edge [label "Edge between node 2 and node 9"]
    edge [label "Edge between node 3 and node 12"]
    edge [label "Edge between node 4 and node 7"]
    edge [label "Edge between node 5 and node 8"]
    edge [label "Edge between node 6 and node 11"]
    edge [label "Edge between node 7 and node 11"]
    edge [label "Edge between node 8 and node 11"]
    edge [label "Edge between node 8 and node 12"]
    edge [label "Edge between node 9 and node 10"]
    edge [label "Edge between node 10 and node 12"]
    edge [label "Edge between node 11 and node 12"]
]
...
graph[
    ...
    node [id 5]
    node [id 6]
    edge [label "Edge between node 0 and node 1 with distance 2"]
    edge [label "Edge between node 0 and node 3 with distance 2"]
    edge [label "Edge between node 0 and node 4 with distance 2"]
    edge [label "Edge between node 1 and node 4 with distance 3"]
    edge [label "Edge between node 2 and node 4 with distance 3"]
    edge [label "Edge between node 3 and node 4 with distance 5"]
    edge [label "Edge between node 2 and node 5 with distance 4"]
    edge [label "Edge between node 2 and node 6 with distance 1"]
]
Input Nodes: [3, 4]
Target Node: 6
...
graph[
    ...
    node [id 17]
    node [id 18]
    edge [label "Edge between node 0 and node 5 with distance 4"]
    edge [label "Edge between node 1 and node 6 with distance 2"]
    edge [label "Edge between node 1 and node 11 with distance 4"]
    edge [label "Edge between node 1 and node 14 with distance 2"]
    edge [label "Edge between node 2 and node 6 with distance 2"]
    edge [label "Edge between node 2 and node 10 with distance 3"]
    edge [label "Edge between node 2 and node 11 with distance 2"]
    edge [label "Edge between node 3 and node 15 with distance 2"]
    edge [label "Edge between node 3 and node 11 with distance 2"]
    edge [label "Edge between node 4 and node 18 with distance 5"]
    edge [label "Edge between node 4 and node 8 with distance 4"]
    edge [label "Edge between node 4 and node 10 with distance 5"]
    edge [label "Edge between node 4 and node 11 with distance 5"]
    edge [label "Edge between node 4 and node 15 with distance 3"]
    edge [label "Edge between node 5 and node 15 with distance 1"]
    edge [label "Edge between node 5 and node 8 with distance 1"]
    edge [label "Edge between node 5 and node 13 with distance 2"]
    edge [label "Edge between node 6 and node 15 with distance 5"]
    edge [label "Edge between node 6 and node 14 with distance 1"]
    edge [label "Edge between node 7 and node 12 with distance 2"]
    edge [label "Edge between node 7 and node 8 with distance 5"]
    edge [label "Edge between node 7 and node 15 with distance 4"]
    edge [label "Edge between node 8 and node 10 with distance 5"]
    edge [label "Edge between node 8 and node 16 with distance 1"]
    edge [label "Edge between node 9 and node 17 with distance 1"]
    edge [label "Edge between node 9 and node 16 with distance 1"]
    edge [label "Edge between node 10 and node 16 with distance 2"]
    edge [label "Edge between node 11 and node 18 with distance 1"]
    edge [label "Edge between node 11 and node 16 with distance 1"]
    edge [label "Edge between node 12 and node 14 with distance 3"]
    edge [label "Edge between node 13 and node 14 with distance 2"]
    edge [label "Edge between node 14 and node 17 with distance 5"]
    edge [label "Edge between node 15 and node 16 with distance 5"]
    edge [label "Edge between node 16 and node 18 with distance 2"]
    edge [label "Edge between node 17 and node 18 with distance 1"]
]
...
graph[
    ...
    node [id 15]
    node [id 16]
    edge [label "Edge between node 0 and node 12 with distance 5"]
    edge [label "Edge between node 1 and node 11 with distance 4"]
    edge [label "Edge between node 1 and node 3 with distance 5"]
    edge [label "Edge between node 2 and node 4 with distance 1"]
    edge [label "Edge between node 2 and node 5 with distance 3"]
    edge [label "Edge between node 2 and node 13 with distance 5"]
    edge [label "Edge between node 3 and node 6 with distance 3"]
    edge [label "Edge between node 3 and node 13 with distance 5"]
    edge [label "Edge between node 3 and node 15 with distance 2"]
    edge [label "Edge between node 4 and node 8 with distance 2"]
    edge [label "Edge between node 4 and node 5 with distance 3"]
    edge [label "Edge between node 4 and node 15 with distance 5"]
    edge [label "Edge between node 5 and node 12 with distance 5"]
    edge [label "Edge between node 6 and node 13 with distance 1"]
    edge [label "Edge between node 6 and node 16 with distance 3"]
    edge [label "Edge between node 7 and node 10 with distance 2"]
    edge [label "Edge between node 7 and node 11 with distance 3"]
    edge [label "Edge between node 7 and node 13 with distance 4"]
    edge [label "Edge between node 8 and node 9 with distance 4"]
    edge [label "Edge between node 9 and node 14 with distance 5"]
    edge [label "Edge between node 9 and node 13 with distance 1"]
    edge [label "Edge between node 10 and node 11 with distance 1"]
    edge [label "Edge between node 10 and node 12 with distance 2"]
    edge [label "Edge between node 11 and node 15 with distance 2"]
    edge [label "Edge between node 11 and node 13 with distance 3"]
    edge [label "Edge between node 12 and node 14 with distance 1"]
    edge [label "Edge between node 13 and node 14 with distance 2"]
    edge [label "Edge between node 14 and node 15 with distance 1"]
    edge [label "Edge between node 15 and node 16 with distance 3"]
]
Input Nodes: [5, 10, 14] 
Target Node: 16
...
graph[
    ...
    node [id 11]
    edge [label "Edge between node 0 and node 2 with distance 2"]
    edge [label "Edge between node 1 and node 5 with distance 2"]
    edge [label "Edge between node 2 and node 9 with distance 2"]
    edge [label "Edge between node 3 and node 7 with distance 3"]
    edge [label "Edge between node 3 and node 11 with distance 5"]
    edge [label "Edge between node 4 and node 5 with distance 3"]
    edge [label "Edge between node 4 and node 6 with distance 3"]
    edge [label "Edge between node 5 and node 7 with distance 5"]
    edge [label "Edge between node 6 and node 8 with distance 1"]
    edge [label "Edge between node 7 and node 11 with distance 1"]
    edge [label "Edge between node 8 and node 10 with distance 5"]
    edge [label "Edge between node 9 and node 10 with distance 2"]
    edge [label "Edge between node 10 and node 11 with distance 2"]
]
Input Nodes: [2, 7, 8]
Target Node: 11
...
graph[
    ...
    node [id 11]
    node [id 12]
    edge [label "Edge between node 0 and node 1 with distance 3"]
    edge [label "Edge between node 1 and node 9 with distance 2"]
    edge [label "Edge between node 1 and node 6 with distance 3"]
    edge [label "Edge between node 2 and node 3 with distance 1"]
    edge [label "Edge between node 2 and node 7 with distance 2"]
    edge [label "Edge between node 2 and node 9 with distance 5"]
    edge [label "Edge between node 3 and node 12 with distance 3"]
    edge [label "Edge between node 4 and node 7 with distance 1"]
    edge [label "Edge between node 5 and node 8 with distance 5"]
    edge [label "Edge between node 6 and node 11 with distance 3"]
    edge [label "Edge between node 7 and node 11 with distance 3"]
    edge [label "Edge between node 8 and node 11 with distance 1"]
    edge [label "Edge between node 8 and node 12 with distance 5"]
    edge [label "Edge between node 9 and node 10 with distance 1"]
    edge [label "Edge between node 10 and node 12 with distance 5"]
    edge [label "Edge between node 11 and node 12 with distance 2"]
]
